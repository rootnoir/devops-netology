...
```shell
root@vagrant:~/terraform# terraform workspace list
* default
```
```shell
root@vagrant:~/terraform# terraform workspace new prod
...
```
```shell
root@vagrant:~/terraform# terraform workspace new stage
...
```
root@vagrant:~/terraform# terraform workspace select prod
...
```
root@vagrant:~/terraform# terraform apply -auto-approve

<...>

Plan: 6 to add, 0 to change, 0 to destroy.
yandex_vpc_network.network-1: Creating...
yandex_vpc_network.network-1: Creation complete after 1s [id=enpc87mmacdtup6mq47f]
yandex_vpc_subnet.subnet-1: Creating...
yandex_vpc_subnet.subnet-1: Creation complete after 1s [id=e9btpljpguhle8qibvkv]
...
yandex_compute_instance.vm-2["instance-2"]: Creation complete after 20s [id=fhm7fjamp1ka0mstho52]
yandex_compute_instance.vm-1[1]: Creation complete after 21s [id=fhmicdg9h17sl981hif8]
yandex_compute_instance.vm-1[0]: Creation complete after 22s [id=fhmfsjk9g866pcp620im]
yandex_compute_instance.vm-2["instance-1"]: Creation complete after 27s [id=fhm52niqg81copv0t3ut]
